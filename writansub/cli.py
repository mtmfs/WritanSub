...
用法:
    writansub-cli pipeline video.mp4 [video2.mp4 ...] [options]
    writansub-cli preprocess video.mp4 [video2.mp4 ...] --denoise [options]
    writansub-cli transcribe video.mp4 [video2.mp4 ...] [-o output.srt] [options]
    writansub-cli align --audio video.wav [video2.wav ...] --srt raw.srt [raw2.srt ...] [options]
    writansub-cli translate input.srt [-o translated.srt] [options]

批处理：transcribe 和 align 接受多个输入文件 / 多对输入；模型在同一进程内只加载一次。
"""
